...
<?php if ( is_front_page() ) : ?>	
	...
	<div id="content" class="site-content clearfix">
		...
		<div class="content-full tagline" role="main" style="background: <?php echo esc_attr( get_theme_mod( 'planum_main_color' ) ); ?> url(<?php $thumbnail = wp_get_attachment_image_src( get_post_thumbnail_id(), 'planum-featured' ); echo $thumbnail[0]; ?>) no-repeat; background-position: 60% 50%; background-size: cover;">
